...
page.done={{{1064,291,0x007aff},{1065,280,0x007aff},{1046,287,0x007aff},}, 85, 994, 139, 1129, 396}
	...
	while os.time()-TimeLine < OutTime do
		if active(bid.YYRecreation,5)then
			...
			elseif d(page.注面主界面,"page.注面主界面")then
				...
				d(page.发送验证码成功,"page.发送验证码成功",true,1)
				if d(page.更新完成_退出游戏,"page.更新完成_退出游戏",true,1)then
					vpn()
				end
			end
		end
...
if true or XXTfakerNewPhone(bid.YYRecreation)then
	delay(1)
	checkphone()
	vpnx()
end
